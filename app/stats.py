...
# ALSO IMPORTANT !!!: WHEN AND IF THIS FUNCTION WAS PUT INTO PRODUCTION, IT WOULD BENEFIT GREATLY FROM INDEXING IMPLEMENTATION ON THE DB SIDE
...
# IMPORTANT !!!: WHEN AND IF THIS FUNCTION WAS PUT INTO PRODUCTION, IT WOULD BENEFIT GREATLY FROM INDEXING IMPLEMENTATION ON THE DB SIDE
